...
export default function CarPriceManager() {
  ...
  if (loading) return (
    <>
      <Head>
        <title>Admin Dashboard - Car Price Manager | Goa Car Rentals</title>
        <meta name="description" content="Manage car rental prices and view customer enquiries in our admin dashboard. Update pricing for our fleet of premium vehicles in Goa." />
                ...
                <table className="min-w-full bg-white" aria-label="Customer enquiries table">
                  <thead className="bg-gray-100">
                    <tr>
                      ...
                      <th className="py-3 px-4 border-b border-gray-200 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider" scope="col">Date</th>
                    </tr>
                  </thead>
