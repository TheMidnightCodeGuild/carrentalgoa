...
const Aboutus = () => {
  ...
  return (
    <>
      <Head>
        <title>About Us - Premier Car Rental Service in Goa | Best Rates & Fleet</title>
        <meta name="description" content="Learn about Goa's most trusted car rental service. We offer well-maintained vehicles, competitive rates, and 24/7 support for a comfortable and safe journey." />
        <meta name="keywords" content="car rental Goa, vehicle rental service, luxury car rental, budget car hire, Goa transportation, trusted car rental" />
