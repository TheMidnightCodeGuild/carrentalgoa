  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Explore our diverse range of premium vehicles for rent in Goa. From luxury SUVs to compact city cars, find the perfect ride for your journey."
        />
        <meta name="keywords" content="car rental goa, luxury cars goa, car hire goa, premium car rental, self drive cars goa" />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Our Premium Fleet | Luxury Car Rentals in Goa" />
        <meta property="og:description" content="Explore our diverse range of premium vehicles for rent in Goa. From luxury SUVs to compact city cars, find the perfect ride for your journey." />
        <meta property="og:type" content="website" />
        <link rel="canonical" href="https://bestcarrentalgoa.com/components/Our-cars" />
      </Head>
                ...
                {carsList.map((car, index) => (
                  ...
                  >
                    <div className="relative h-56 sm:h-60 md:h-48 overflow-hidden">
                      <Image
                        src={car.image}
                        alt={`${car.name} - Car Rental in Goa`}
                        fill
