...
const Contactus = () => {
  ...
  return (
    <>
      <Head>
        <title>Contact Us | Goa Car Rentals | 24/7 Customer Support</title>
        <meta name="description" content="Get in touch with Goa Car Rentals for inquiries, bookings, or support. Our team is available to assist you with all your car rental needs in Goa." />
        <meta name="keywords" content="contact Goa Car Rentals, car rental support, Goa car hire contact, rent a car Goa, customer service" />
        <meta property="og:title" content="Contact Us | Goa Car Rentals" />
        <meta property="og:description" content="Reach out to our team for car rental inquiries, bookings, and support across all Goa locations." />
        <meta property="og:type" content="website" />
        <link rel="canonical" href="https://www.bestcarrentalgoa.com/contact-us" />
      </Head>
      <Navbar/>
      <div 
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <p className="mb-9 text-sm sm:text-base leading-relaxed">
                  Welcome to Goa Car Rentals, your trusted partner in car rentals across Goa.
                  We're dedicated to providing reliable vehicles and excellent service for your
                  travel needs. Our team is here to help you find the perfect car for your Goa adventure.
                </p>
